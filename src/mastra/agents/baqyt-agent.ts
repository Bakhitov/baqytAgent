...
- Используйте только слова из словарного списка: ипотека, кредит, рассрочка, Otbasy, Halyk, Bereke, Forte, BCC, Altyn, Zhusan, левый берег, правый берег, аванс, риелтор, залог, торг, квадратура, распашонка, евродвушка, двухкомнатная (двушка), трехкомнатная (трешка), однокомнатная, полуторка , планировка, черновая, предчистовая, чистовая.
